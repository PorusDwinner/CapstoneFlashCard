...
const CreateFlashCard = () => {
  ...
  // nanoid() is used to create the id of the flashcard, it will be used later when we have to render the specific flashcard on user demand
            ...
            <div className="flex flex-col px-10 py-4 bg-white drop-shadow-lg space-y-2.5 rounded-md"  >
              <div className='flex sm:flex-row items-center space-x-10 pt-3' id='groupDescriptionDiv' >
                ...
                <div className='flex flex-col'>
                  ...
                  <Field type='text' name='groupName' placeholder='Group Name...' id='description'
                    className="border-slate-300 p-2 lg:mt-2 md:w-96 border-2 rounded-sm focus:ring-slate-300 focus:border focus:border-slate-400" />
                ...
                {groupImg ? (
                  ...
                  (
                    <button type='button' onClick={() => filePickerRef.current.click()} id='uploadImage'
                      ...
                      <input type='file' ref={filePickerRef} value={groupImg}
                        onChange={(e) => {
              ...
              <div className='flex flex-col w-full sm:w-[65%]'>
                ...
                <Field as='textarea' name='description' rows={4}
                  ...
                  className="resize-none border-slate-300 border-2 p-2 rounded-sm placeholder:opacity-40 focus:ring-slate-400 focus:border focus:border-slate-400" />
                <p className='text-sm text-red-300'>
                    ...
                    return (
                      <div>
                              ...
                              <div className="flex flex-col justify-around space-y-3 md:space-x-10 md:flex-row" >
                                ...
                                <div className="relative flex flex-col justify-center space-y-3">
                                  ...
                                  <Field type='text' name={`term.${index}.termName`} innerRef={editRef} rows={3}
                                    className="border-slate-300 border-2 p-2 rounded-sm focus:ring-slate-300 focus:border focus:border-slate-400 lg:w-48 xl:w-56 2xl:60" />
                                  <p className='text-sm text-red-300'>
                                ...
                                <div id='termDefinationDiv' className='relative flex flex-col justify-center space-y-3' >
                                  ...
                                  <Field as='textarea' name={`term.${index}.termDefination`}
                                    className="resize-none border-slate-300 border-2 p-2 rounded-sm placeholder:opacity-40 focus:ring-slate-400 focus:border focus:border-slate-400 lg:w-60 xl:w-80 2xl:w-96" />
                                  <p className='text-sm text-red-300'>
                                ...
                                <div className='flex items-center spacex-x-2'>
                                  <button disabled className='hidden lg:flex lg:items-center lg:w-[19rem] lg:mt-4 px-2 py-2 bg-white border-2 border-blue-600 active:border-slate-300 text-blue-700 font-semibold rounded-md space-x-2'>
                                    <BiPlus />
                                    Select Image
                                  </button>
                        ...
                        <button type='button' onClick={() =>
                          ...
                          className="flex items-center space-x-2 text-blue-600 font-medium text-md bg-white w-full mb-5 px-5 py-2">
                          <BiPlus />
                          <p>Add More</p>
                        </button>
